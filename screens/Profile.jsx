...
const Profile = ({ navigation }) => {
  ...
  return (
    <View className="flex-1 bg-white">
      ...
      {showEditUser && <EditUsername close={() => setShowEditUser(false)} />}
      <ScrollView>
          ...
          <View className="flex-row justify-between items-end mb-7 mt-2">
            <View className="flex- flex-shrink pr-5">
              <View className="">
                ...
                <Text className="text-sm mt-1 text-gray-400" numberOfLines={1}>
                  {suggestionType}
                </Text>
              </View>
            </View>
        ...
        <View className="px-5 mb-[95px]">
          ...
          >
            <Text className="text-[15px] font-semibold">Edit User Details</Text>
          </TouchableOpacity>
          <TouchableOpacity
            className="p-4 mb-4 bg-white border border-gray-100 rounded"
